...
int main()
{
	// integers hold whole numbers with no decimals
	int num; // variable named num that holds numbers without decimal places
	num = 1; // storing the value of 1 into num
	// display the value of num
	cout << "num = " << num << endl;
	
	// declaration using intiialization
	int num2 = 2; 	// declares a variable named num2 and initializes
					// the value to 2
	...
	// answer holds the value of mod dividing num by num2
	answer = num % num2;
	cout << "num % num2 = " << answer << endl;
	
	// answer holds the value of mod dividing num2 by num
	answer = num2 % num;
	cout << "num2 % num = " << answer << endl;
}
